...
wget -O ~/service/dir_ob/batocera-compositor https://github.com/ajones/bcontainers/raw/master/steam/desktop/service/dir_ob/batocera-compositor
wget -O ~/service/dir_ob/full.xml https://github.com/ajones/bcontainers/raw/master/steam/desktop/service/dir_ob/full.xml
wget -O ~/service/dir_ob/window.xml https://github.com/ajones/bcontainers/raw/master/steam/desktop/service/dir_ob/window.xml
...
curl -L -o ~/services/windowed https://github.com/ajones/bcontainers/raw/master/steam/desktop/services/windowed
...
curl -L -o /userdata/desktop/LXDE.sh https://github.com/ajones/bcontainers/raw/master/steam/desktop/LXDE.sh
echo "Downloading MATE script..."
curl -L -o /userdata/desktop/MATE.sh https://github.com/ajones/bcontainers/raw/master/steam/desktop/MATE.sh
echo "Downloading XFCE script..."
curl -L -o /userdata/desktop/XFCE.sh https://github.com/ajones/bcontainers/raw/master/steam/desktop/XFCE.sh
