...
export aur_packagelist="geforcenow-electron mcpelauncher-appimage parsec-bin protonup-qt greenlight-bin azahar-appimage rpcs3-bin  86box-roms 86box-manager-bin sgdboop-bin winegui-bin icu66-bin libffi7 \
 zoom"
