...
cd $thisdir
wget -q --tries=10 -O $thisdir/utils_dwarfs.tar.gz https://github.com/suki-san/archbat/raw/master/steam/build/utils_dwarfs.tar.gz
...
export aur_packagelist="geforcenow-electron mcpelauncher-appimage parsec-bin protonup-qt greenlight-bin azahar-appimage rpcs3-bin  86box-roms 86box-manager-bin sgdboop-bin winegui-bin icu66-bin davinci-resolve \
 zoom"
...
"curl -Ls https://github.com/suki-san/archbat/raw/master/steam/build/patch.sh | bash && exit"
# ------------------------------------------------------------------------------------------
