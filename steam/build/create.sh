...
libretro-retrodream libretro-yabause pcsx2-git cemu-git citron-git ryujinx shadps4-git 86box cinnamon-desktop cinnamon-control-center cinnamon-menus cinnamon-screensaver  \
